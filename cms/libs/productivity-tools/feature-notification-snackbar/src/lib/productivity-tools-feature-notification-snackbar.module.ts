...
import { ReminderNotificationSnackBarTemplateComponent } from './containers/reminder-notification-snack-bar-template/reminder-notification-snack-bar-template.component';
@NgModule({
  imports: [
    CommonModule,
