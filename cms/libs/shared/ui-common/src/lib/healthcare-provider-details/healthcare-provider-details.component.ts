...
@Component({
  selector: 'cms-healthcare-provider-details',
  templateUrl: './healthcare-provider-details.component.html',
  styleUrls: ['./healthcare-provider-details.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HealthcareProviderDetailsComponent implements OnInit {
