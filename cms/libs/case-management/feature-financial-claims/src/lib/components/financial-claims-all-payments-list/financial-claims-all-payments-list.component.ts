...
export class FinancialClaimsAllPaymentsListComponent implements OnInit, OnChanges{
  ...
  gridFinancialClaimsAllPaymentsData$ = this.gridFinancialClaimsAllPaymentsDataSubject.asObservable();
  ...
  navToReconcilePayments(event : any){  
    ...
    this.route.navigate(['/financial-management/claims/' + this.claimsType +'/payments/reconcile-payments'] );
  }
