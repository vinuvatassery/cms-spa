/** Angular **/
import { Component, OnInit, ChangeDetectionStrategy, ViewEncapsulation, ViewChild, Output, EventEmitter, ElementRef, Inject, Input, OnDestroy, ChangeDetectorRef } from '@angular/core';
