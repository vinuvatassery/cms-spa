...
export class FinancialMedicalPremiumsDataService {
  /** Constructor**/
  constructor(
  ...
  loadMedicalPremiumsProcessListService( ) {
    return of([
      {
        invoiceID:1,
  ...
  loadMedicalPremiumsBatchListService( ) {
    return of([
      {
        id:1,
        batch: '05012021_001 `',
  ...
  loadMedicalPremiumsAllPaymentsListService( ) {
    return of([
      {
        batch: 'MMDDYYYY_XXX',
