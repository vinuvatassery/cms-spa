...
export class FinancialPremiumsDataService {
  ...
  loadFinancialPremiumsBatchListService(parms: GridFilterParam, claimsType : string ) {
    return this.http.post<any>(
      `${this.configurationProvider.appSettings.caseApiUrl}/financial-management/premiums/${claimsType}/batches`,parms
    );
  }
