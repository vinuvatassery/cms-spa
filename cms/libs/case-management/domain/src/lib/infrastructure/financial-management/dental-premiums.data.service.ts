...
export class FinancialDentalPremiumsDataService {
  /** Constructor**/
  constructor(
  ...
  loadDentalPremiumsProcessListService( ) {
    return of([
      {
        invoiceID:1,
  ...
  loadDentalPremiumsBatchListService( ) {
    return of([
      {
        id:1,
        batch: '05012021_001 `',
  ...
  loadDentalPremiumsAllPaymentsListService( ) {
    return of([
      {
        batch: 'MMDDYYYY_XXX',
