...
@Component({
  selector: 'cms-dental-claims-batches-log-lists',
  templateUrl: './dental-claims-batches-log-lists.component.html', 
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DentalClaimsBatchesLogListsComponent implements OnInit, OnChanges {
  ...
  gridDataHandle() {
   ...
   backToBatch(event : any){  
    this.route.navigate(['/financial-management/dental-claims'] );
  }

  goToBatchItems(event : any){  
    this.route.navigate(['/financial-management/dental-claims/batch/items'] );
  }

  navToReconcilePayments(event : any){  
    this.route.navigate(['/financial-management/dental-claims/batch/reconcile-payments'] );
  }
