...
@Component({
  selector: 'cms-dental-claims-batch-list-detail-items',
  templateUrl: './dental-claims-batch-list-detail-items.component.html', 
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DentalClaimsBatchListDetailItemsComponent implements OnInit, OnChanges {
