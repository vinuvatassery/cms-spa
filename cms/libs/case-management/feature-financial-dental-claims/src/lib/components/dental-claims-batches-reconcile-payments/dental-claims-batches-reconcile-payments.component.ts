...
@Component({
  selector: 'cms-dental-claims-batches-reconcile-payments',
  templateUrl: './dental-claims-batches-reconcile-payments.component.html',
  styleUrls: ['./dental-claims-batches-reconcile-payments.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DentalClaimsBatchesReconcilePaymentsComponent implements OnInit, OnChanges{
