...
@Component({
  selector: 'cms-medical-premiums-batches-reconcile-payments',
  templateUrl: './medical-premiums-batches-reconcile-payments.component.html',
  styleUrls: ['./medical-premiums-batches-reconcile-payments.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MedicalPremiumsBatchesReconcilePaymentsComponent implements OnInit, OnChanges{
