...
@Component({
  selector: 'cms-dental-premiums-batches-reconcile-payments',
  templateUrl: './dental-premiums-batches-reconcile-payments.component.html',
  styleUrls: ['./dental-premiums-batches-reconcile-payments.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DentalPremiumsBatchesReconcilePaymentsComponent implements OnInit, OnChanges{
