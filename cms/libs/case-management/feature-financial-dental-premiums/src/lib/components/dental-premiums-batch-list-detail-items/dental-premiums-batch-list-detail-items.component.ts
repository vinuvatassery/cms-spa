...
@Component({
  selector: 'cms-dental-premiums-batch-list-detail-items',
  templateUrl: './dental-premiums-batch-list-detail-items.component.html', 
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DentalPremiumsBatchListDetailItemsComponent implements OnInit, OnChanges {
