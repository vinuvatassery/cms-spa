...
@Component({
  selector: 'cms-dental-premiums-batches-log-lists',
  templateUrl: './dental-premiums-batches-log-lists.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DentalPremiumsBatchesLogListsComponent
