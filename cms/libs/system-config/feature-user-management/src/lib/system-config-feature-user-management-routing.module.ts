...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'sms-text-template/new-sms-template',
        component: SmsTextTemplateNewFormComponent,
      },
      {
      ...
      },
      {
        ...
        component: ClientNotificationDefaultsListComponent
      },
      {
        path: 'form-documents',
        component: FormDocumentsListComponent
      },
    ],
  },
  {
