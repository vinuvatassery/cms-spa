...
  private paymentReversalSubject = new BehaviorSubject<Lov[]>([]);
  ...
  private lovClaimStatusSubject = new BehaviorSubject<Lov[]>([]);
      /** Public properties **/
  ...
  claimStatus$ = this.lovClaimStatusSubject.asObservable()
